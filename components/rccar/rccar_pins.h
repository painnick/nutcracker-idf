...
/* DRV8833 #2 후륜 */
#define RCCAR_PIN_RL_IN1 (GPIO_NUM_18)
#define RCCAR_PIN_RL_IN2 (GPIO_NUM_19)
#define RCCAR_PIN_RR_IN1 (GPIO_NUM_21)
#define RCCAR_PIN_RR_IN2 (GPIO_NUM_22)

/* DRV8833 #3 포탑 */
#define RCCAR_PIN_TURRET_IN1 (GPIO_NUM_NC)
#define RCCAR_PIN_TURRET_IN2 (GPIO_NUM_NC)
...
/* 74HC595 x4 */
#define RCCAR_PIN_595_DATA  (GPIO_NUM_NC)
