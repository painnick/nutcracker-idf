...
| 가습기 | GPIO4, X 버튼 시 2초 ON, 1초 이상 정지 후 출발 시 1초 ON. ON 때 0005.mp3. 네오픽셀 주황 유지 후 흰색 전환 |
| 네오픽셀 | WS2812 8개 (GPIO13), 가습기/배기 시 주황 |
...
| 레이더 서보 | 32 | LEDC 50 Hz, Y로 켤 때 PWM 연결. 켠 뒤 정지 시에만 왕복 |
...
| 1초 이상 정지 후 출발 | 가습기 + 네오픽셀 1초 ON (배기 효과, 0005.mp3) |
